        ...
        <div id='Inicio'>
            <section class="home" id='H'>
                <div class="box__banner">
                    <img class="banner__img" id="banner__img" src="assets/img/NUEVO_FRASE_ENFO.jpg" alt="Fundacion Enfoque">
                </div>
            </section>
        </div>
        <!--===== ABOUT =====-->
                ...
                <div class="about__container bd-grid">
                    <div class="about__container-text">
                        ...
                        <p class="about__text">Somos una institución privada sin ánimo de lucro, que trabaja por la
                            ...
                            desarrollo para personas en situación de vulnerabilidad.
                        </p>
                        <p class="about__text">
                            Esta herramienta es motivada por razones de índole
